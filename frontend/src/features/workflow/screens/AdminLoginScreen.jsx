  ...
  const onSubmit = useCallback(
    async (event) => {
      ...
      try {
        ...
        const userAccessRole = String(user.accessRole || '').toLowerCase()
        
        if (userRole !== 'admin' && userAccessRole !== 'admin') {
          await logout() // Kick them out instantly
    ...
    [form.identifier, form.password, isValid, login, navigate, logout],
  )
  ...
  return (
    <Container>
      <Header>
        ...
        <StyledTitle>Admin Portal</StyledTitle>
        <StyledSubtitle>Authorized personnel only. Sign in to access the system dashboard.</StyledSubtitle>
      </Header>
